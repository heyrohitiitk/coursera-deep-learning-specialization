...
- Before we normalized input by subtracting the mean and dividing by std. This helped a lot for the shape of the cost function and for reaching the minimum point faster.
